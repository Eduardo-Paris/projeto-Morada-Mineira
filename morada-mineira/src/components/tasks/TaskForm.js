    ...
    >
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div className="input-group">
          ...
          <textarea className="textarea" value={formData.description} onChange={(e) => handleChange("description", e.target.value)} placeholder="Descreva a tarefa em detalhes..." />
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          ...
          <div className="input-group">
            <label>Prazo</label>
            <input className="input" type="date" value={formData.due_date} onChange={(e) => handleChange("due_date", e.target.value)} />
          </div>
        </div>

        <div className="input-group">
          <label>Atribuir para</label>
          <select className="select" value={formData.assigned_to} onChange={(e) => handleAssigneeChange(e.target.value)}>
